...
template <class ScalarT>
[[nodiscard]] constexpr fractional_result<ScalarT> area(ball<2, ScalarT> const& b)
{
    return tg::pi_scalar<fractional_result<ScalarT>> * tg::pow2(b.radius);
}

template <class ScalarT>
[[nodiscard]] constexpr fractional_result<ScalarT> area(ball<3, ScalarT> const& b)
{
...
template <class ScalarT>
[[nodiscard]] constexpr fractional_result<ScalarT> area(disk<2, ScalarT> const& b)
{
    return tg::pi_scalar<fractional_result<ScalarT>> * tg::pow2(b.radius);
}

template <class ScalarT>
[[nodiscard]] constexpr fractional_result<ScalarT> area(disk<3, ScalarT> const& b)
{
    return tg::pi_scalar<fractional_result<ScalarT>> * tg::pow2(b.radius);
}
...
template <class ScalarT>
[[nodiscard]] constexpr ScalarT area(rect<2, ScalarT> const& b)
{
    // TODO: FIXME
...
template <class ScalarT>
[[nodiscard]] constexpr ScalarT area(rect<3, ScalarT> const& b)
{
    // TODO: FIXME
    return pow2(b.length);
}
...
template <class ScalarT>
[[nodiscard]] constexpr ScalarT area(pyramid<3, ScalarT> const& b)
{
    // TODO: FIXME
