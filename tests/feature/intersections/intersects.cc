...
FUZZ_TEST("IntersectsSegment3Sphere3")(tg::rng& rng)
{
    ...
    // 1st case: segment points inside sphere
    ...
    // 2nd case: one segment point inside the sphere and one outside
    ...
    // 3rd case: both segment points outside of the sphere
...
FUZZ_TEST("IntersectsBox3Triangle3")(tg::rng& rng)
{
    ...
    // 1st case: triangle inside of the box
...
FUZZ_TEST("IntersectsSphere3Plane3")(tg::rng& rng)
{
    ...
    // 1st case: rng sphere with center above the plane
    ...
    // 2nd case: rng sphere and tangential plane
...
FUZZ_TEST("IntersectsBox3Box3")(tg::rng& rng)
{
    ...
    // 3rd case: rigid transformation invariance (rotation + translation)
